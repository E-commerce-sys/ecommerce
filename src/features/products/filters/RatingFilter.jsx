  ...
  return (
    <div className="flex items-center gap-2" ref={wrapperRef}>
      <div className="relative">
        ...
        {open && (
          <div className={`absolute top-full mt-2 ${dir === "rtl" ? "right-0" : "left-0"} z-50 bg-white border border-[rgb(var(--color-primary-1))] rounded-lg shadow-lg overflow-hidden w-46`}>
