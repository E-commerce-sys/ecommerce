    ...
    <div className="flex w-full min-w-0 flex-col items-center gap-3 rounded-2xl border border-[rgb(var(--color-border))] py-4 sm:gap-4 sm:rounded-3xl sm:py-6">
      <div className="relative w-full max-w-3xl px-2 sm:px-4">
        <div className="relative flex w-full items-center">
          <div
            className="pointer-events-none absolute left-2 right-2 top-1/2 h-1 -translate-y-1/2 rounded-full bg-[rgb(var(--color-grey))]"
            aria-hidden
          />
          <div
            className="pointer-events-none absolute left-2 top-1/2 h-1.5 -translate-y-1/2 rounded-full bg-[rgb(var(--color-border))] transition-all duration-500"
            style={{
        ...
        <div className="mt-2 flex w-full min-w-0 sm:mt-3">
          {steps.map((step) => (
            ...
            >
              <p className="max-w-[3.25rem] text-center text-[0.65rem] leading-tight break-words capitalize text-[rgb(var(--color-text-main-3))] sm:max-w-[4.5rem] sm:text-xs">
                {step}
              </p>
            </div>
          ))}
